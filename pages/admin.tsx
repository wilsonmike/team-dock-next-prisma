...
const Admin = () => {
    ...
    return (
        <div className="container mx-auto max-w-md py-12">
            ...
            <form action="" className="grid grid-cols-1 gap-y-6 shadow-lg p-8 rounded-lg" onSubmit={handleSubmit(onSubmit)}>
                ...
                <button disabled={loading} type="submit" className='my-4 capitalize bg-blue-500 text-white font-medium py-2 px-4 rounded-md hover:bg-blue-600' >
                    {loading ? (
                        <span className="flex items-center justify-center">
                            <svg className='w-6 h-6 animate-spin mr-1' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
